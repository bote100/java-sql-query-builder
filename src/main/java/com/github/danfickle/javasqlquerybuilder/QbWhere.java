...
public interface QbWhere {
    ...
    /**
     * Similar to {@link #where(String, Object) where} but allows you
    ...
    /**
     * Similar to {@link #where(String, Object) where} but is joined by an OR WHERE.
     *
     * @param field
     * @param val
     * @return This where builder.
    ...
    /**
     * Similar to {@link #orWhere(String, Object) orWhere} but allows you to
